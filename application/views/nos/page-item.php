                    ...
                    <div class="row">
                        <div class="col-md-2 align-self-center">
                            <div class="mb-0 pb-0" dir="ltr">
                                <input class="knob" data-width="100%" data-height="100%" data-linecap=round data-fgColor="#5b73e8" value="<?= number_format($persentase, 0) ?>" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".2" />
                            </div>
                        </div>
                        <div class="col-md-10 align-self-center">
